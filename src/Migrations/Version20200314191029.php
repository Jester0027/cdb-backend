 ...
 */
final class Version20200314191029 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_theme AS SELECT id, name, description FROM event_theme');
        $this->addSql('DROP TABLE event_theme');
        $this->addSql('CREATE TABLE event_theme (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO event_theme (id, name, description) SELECT id, name, description FROM __temp__event_theme');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__refuge AS SELECT id, name, address, city, zip_code, coordinates, description FROM refuge');
        $this->addSql('DROP TABLE refuge');
        $this->addSql('CREATE TABLE refuge (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, zip_code INTEGER NOT NULL, coordinates VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO refuge (id, name, address, city, zip_code, coordinates, description) SELECT id, name, address, city, zip_code, coordinates, description FROM __temp__refuge');
