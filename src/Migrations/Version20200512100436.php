 ...
 */
final class Version20200512100436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, event_theme_id, title, event_date, address, city, coordinates, image_url, description, zip_code, updated_at FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_theme_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, event_date DATETIME NOT NULL, address VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, coordinates VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, zip_code VARCHAR(255) NOT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_3BAE0AA71FEE9D57 FOREIGN KEY (event_theme_id) REFERENCES event_theme (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, event_theme_id, title, event_date, address, city, coordinates, image_url, description, zip_code, updated_at) SELECT id, event_theme_id, title, event_date, address, city, coordinates, image_url, description, zip_code, updated_at FROM __temp__event');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_theme_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, event_date DATETIME NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, coordinates VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, description CLOB NOT NULL, image_url VARCHAR(255) NOT NULL COLLATE BINARY)');
