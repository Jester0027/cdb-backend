 ...
 */
final class Version20200521104307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, event_theme_id, title, event_date, address, city, coordinates, description, zip_code, updated_at, image_url FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_theme_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, event_date DATETIME NOT NULL, address VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, coordinates VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, zip_code VARCHAR(255) NOT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_3BAE0AA71FEE9D57 FOREIGN KEY (event_theme_id) REFERENCES event_theme (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, event_theme_id, title, event_date, address, city, coordinates, description, zip_code, updated_at, image_url) SELECT id, event_theme_id, title, event_date, address, city, coordinates, description, zip_code, updated_at, image_url FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__refuge AS SELECT id, name, address, city, coordinates, description, slug, zip_code FROM refuge');
        $this->addSql('DROP TABLE refuge');
        $this->addSql('CREATE TABLE refuge (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, coordinates VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL COLLATE BINARY, zip_code VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO refuge (id, name, address, city, coordinates, description, slug, zip_code) SELECT id, name, address, city, coordinates, description, slug, zip_code FROM __temp__refuge');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_theme_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, event_date DATETIME NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, coordinates VARCHAR(255) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description CLOB NOT NULL)');
